...
Java_com_yny_mlocr_plite_OCRPredictorNative_init(
...
Java_com_yny_mlocr_plite_OCRPredictorNative_forward(
...
Java_com_yny_mlocr_plite_OCRPredictorNative_release(
