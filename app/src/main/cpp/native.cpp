...
Java_com_yny_mlocr_paddlelite_OCRPredictorNative_init(
...
Java_com_yny_mlocr_paddlelite_OCRPredictorNative_forward(
...
Java_com_yny_mlocr_paddlelite_OCRPredictorNative_release(
